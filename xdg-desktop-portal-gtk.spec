...
Source0  : https://github.com/flatpak/xdg-desktop-portal-gtk/releases/download/1.4.0/xdg-desktop-portal-gtk-1.4.0.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-gtk-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569646008
