...
Version  : 1.15.3
Release  : 19
URL      : https://github.com/flatpak/xdg-desktop-portal-gtk/releases/download/1.15.3/xdg-desktop-portal-gtk-1.15.3.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-gtk-1.15.3
cd %{_builddir}/xdg-desktop-portal-gtk-1.15.3
pushd ..
cp -a xdg-desktop-portal-gtk-1.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742853203
