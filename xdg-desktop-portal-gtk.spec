...
Source0  : https://github.com/flatpak/xdg-desktop-portal-gtk/releases/download/1.15.1/xdg-desktop-portal-gtk-1.15.1.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-gtk-1.15.1
cd %{_builddir}/xdg-desktop-portal-gtk-1.15.1
pushd ..
cp -a xdg-desktop-portal-gtk-1.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720015910
