...
Source0  : https://github.com/flatpak/xdg-desktop-portal-gtk/releases/download/1.14.0/xdg-desktop-portal-gtk-1.14.0.tar.xz
...
%prep
%setup -q -n xdg-desktop-portal-gtk-1.14.0
cd %{_builddir}/xdg-desktop-portal-gtk-1.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647907697
...
cp %{_builddir}/xdg-desktop-portal-gtk-1.14.0/COPYING %{buildroot}/usr/share/package-licenses/xdg-desktop-portal-gtk/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
